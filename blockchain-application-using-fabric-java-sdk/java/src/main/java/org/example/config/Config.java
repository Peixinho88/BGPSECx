...
public class Config {
	...
	public static final String ORG3_USR_BASE_PATH = "crypto-config" + File.separator + "peerOrganizations"
			+ File.separator + "org3.example.com" + File.separator + "users" + File.separator + "Admin@org3.example.com"
			+ File.separator + "msp";
	...
	public static final String ORG3_PEER_2 = "peer2.org3.example.com";

	public static final String ORG3_PEER_2_URL = "grpc://localhost:9060";
